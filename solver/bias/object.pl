...
body_pred(block,4).
body_pred(in_start,3).
body_pred(in_rank,3).
body_pred(rank_rev,2).
body_pred(gap,4).
...
type(out_block,('ex', 'rank', 'size', 'size', 'value')).
type(block,('ex', 'block_id', 'size', 'value')).
type(in_start,('ex', 'block_id', 'size')).
type(in_rank,('ex', 'block_id', 'rank')).
type(rank_rev,('rank', 'rank')).
...
bad_body(in_start, Vars):- vars(_, Vars), Vars = (V0,_,_), V0 != 0.
bad_body(in_rank, Vars):- vars(_, Vars), Vars = (V0,_,_), V0 != 0.
