...
type(obj_succ,('ex','num','num')).
type(out_succ,('ex','num','num')).
type(obj_pair,('ex','num','num')).
type(gap,('ex','num','num','num')).
type(largest,('ex','num')).
type(non_largest,('ex','num')).
type(succ,('num','num')).
...
:- clause(C), not body_literal(C, block, 4, (0,1,_,_)), not body_literal(C, succ, 2, (1,_)), not body_literal(C, succ, 2, (_,1)), not body_literal(C, add, 3, (1,_,_)), not body_literal(C, add, 3, (_,_,1)), not body_literal(C, obj_succ, 3, (0,1,_)), not body_literal(C, obj_succ, 3, (0,_,1)), not body_literal(C, out_succ, 3, (0,1,_)), not body_literal(C, out_succ, 3, (0,_,1)).
