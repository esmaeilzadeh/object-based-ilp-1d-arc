...
:- clause(C), not body_literal(C, block, 4, (0,1,_,_)), not body_literal(C, succ, 2, (1,_)), not body_literal(C, succ, 2, (_,1)), not body_literal(C, add, 3, (1,_,_)), not body_literal(C, add, 3, (_,_,1)), not body_literal(C, obj_succ, 3, (0,1,_)), not body_literal(C, obj_succ, 3, (0,_,1)).
