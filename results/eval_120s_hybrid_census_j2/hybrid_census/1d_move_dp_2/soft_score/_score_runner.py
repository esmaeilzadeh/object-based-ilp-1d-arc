...
test_path = 'results/eval_120s_hybrid_census_j2/hybrid_census/1d_move_dp_2/encode/test.pl'
prog_file = 'results/eval_120s_hybrid_census_j2/hybrid_census/1d_move_dp_2/soft_score/_score_prog.pl'
try:
    consult(do_test)
    consult(test_path)
    consult(prog_file)
