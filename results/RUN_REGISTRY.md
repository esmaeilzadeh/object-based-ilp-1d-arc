...
| `eval_120s_first3_j2` | Same code SHA `39af98ec1bd6dc55137146be136834838b1a0ecd` as `eval_60s_build_restart`. **39/54** exact = soft @120 s, `JOBS=2`, `DELAY=5`, trials `0,1,2`. Artifacts: `results/eval_120s_first3_j2/block_primary/summary.json`. **−1 vs 40/54 @60 s** on the same commit: `1d_recolor_cnt_2` `decode_error` (longer search found a different program). `1d_flip_1` SIGSEGV again (signal 11, two offline retries). Not a headline; do not treat 39/54 as a capability regression vs the 60 s gate. |
