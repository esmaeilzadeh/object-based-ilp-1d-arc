...
| `eval_60s_build_restart` | Fresh-agent verify of environment build `bld-20260813-0449d933-0322-478f-a982-5819350938aa`. Code SHA `39af98ec1bd6dc55137146be136834838b1a0ecd` (instance-color-constants tip) on branch `cursor/eval-60s-build-restart-5b15`. **40/54** exact = soft @60 s, `JOBS=2`, `DELAY=5`, trials `0,1,2`. Artifacts: `results/eval_60s_build_restart/block_primary/summary.json`. Matches the 40/54 headline knobs; `1d_flip_1` SIGSEGV (signal 11) on the parallel pass and two offline retries — recorded as failure, not a solver regression. |
