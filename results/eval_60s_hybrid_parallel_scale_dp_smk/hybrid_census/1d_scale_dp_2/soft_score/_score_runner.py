...
test_path = 'results/eval_60s_hybrid_parallel_scale_dp_smk/hybrid_census/1d_scale_dp_2/encode/test.pl'
prog_file = 'results/eval_60s_hybrid_parallel_scale_dp_smk/hybrid_census/1d_scale_dp_2/soft_score/_score_prog.pl'
try:
    consult(do_test)
    consult(test_path)
    consult(prog_file)
